...
%   pairwise_align_bayes     - Align two functions using geometric properties of warping functions
%   Phase_Boxplot            - Phase Boxplot
...
%   time_warping_median      - Group-wise function alignment
