...
if ispc
	...
	if isempty(lapacklib)
		lapacklib = fullfile(matlabroot,'extern','lib',computer('arch'),'MinGW',...
	    'libmwlapack.lib');
		blaslib = fullfile(matlabroot,'extern','lib',computer('arch'),'MinGW',...
	    'libmwblas.lib');
	end
	...
	blaslib, lapacklib, '-output', ['./BinaryFiles/' filename ]);
else
	mex('-I./', ...
	'-I./BinaryFiles/', ...
	'-I./Manifolds/', ...
